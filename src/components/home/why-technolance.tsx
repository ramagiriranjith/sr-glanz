...
export function WhyTechnolance() {
  return (
    <section className="bg-[#fff1de] py-20 lg:py-24">
      <div className="container mx-auto px-4 md:px-6 lg:px-10">
        <div className="flex flex-col items-center text-center mb-10 md:mb-14">
          ...
          <p className="text-[#1A1A1A] text-base md:text-lg font-normal leading-relaxed max-w-2xl">
        ...
        <div className="relative w-full rounded-[12px] overflow-hidden bg-gray-200">
          <Image
            ...
            alt="SR Glanz office environment showing team collaboration"
            width={1200}
            height={675}
