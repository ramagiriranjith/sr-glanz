    ...
    <section className="bg-[var(--color-background)] py-16 lg:py-24">
      <div className="container mx-auto px-4 md:px-6 lg:px-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
          ...
          {/* Left Column - Ready to elevate... */}
          <div className="relative overflow-hidden rounded-[32px] bg-[#C3E944] p-8 md:p-12 lg:p-16 flex flex-col justify-center items-start">
            {/* Background Pattern */}
             ...
             <div className="relative z-10 w-full max-w-lg">
                ...
                <p className="font-[family-name:var(--font-body)] text-base md:text-lg mb-8 text-[#1A1A1A] leading-[1.6]">
                  Connect with our expert team today and discover how we can turn your digital challenges into opportunities for growth.
                </p>
                <div>
                  <Link 
                    href="/contact" 
                    className="inline-flex items-center justify-center bg-white text-[#1A1A1A] font-semibold text-base px-8 py-3.5 rounded-full hover:bg-[#F2F4E6] transition-colors"
                  >
                    Let&#39;s get started
                  </Link>
                </div>
          ...
          <div className="relative overflow-hidden rounded-[32px] bg-[#F9F9F6] p-8 md:p-12 lg:p-16 flex flex-col justify-center items-start">
             ...
             <div className="relative z-10 w-full max-w-lg">
                ...
                <p className="font-[family-name:var(--font-body)] text-base md:text-lg mb-8 text-[#595959] leading-[1.6]">
                ...
                <form className="relative flex items-center w-full max-w-md bg-white rounded-full p-2 pl-4 shadow-sm border border-transparent">
                   ...
                   <input 
                      ...
                      className="flex-grow bg-transparent border-none outline-none text-[#1A1A1A] placeholder:text-[#999999] text-base h-full py-2 min-w-0 font-[family-name:var(--font-body)]"
                      required
                   />
                   <button 
                      type="submit" 
                      className="flex-shrink-0 group w-8 h-8 md:w-10 md:h-10 flex items-center justify-center rounded-full hover:bg-gray-100 transition-colors ml-2 cursor-pointer"
