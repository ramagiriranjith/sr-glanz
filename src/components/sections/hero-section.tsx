      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-10 max-w-[1200px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="flex flex-col items-start max-w-[600px] lg:max-w-none">
            <h1 className="font-display text-[2.5rem] leading-[1.1] md:text-[3.75rem] font-medium text-[#1A1A1A] mb-6">
              Empowering IT Teams.{" "}
              <em className="italic">Enabling Seamless Implementation.</em>
            </h1>
            
            <p className="font-body text-base md:text-[1.125rem] text-[#595959] leading-relaxed mb-6 max-w-[540px]">
              Technolance bridges the IT talent gap and powers execution, from
            ...
            <Link
              href="#services"
              className="inline-flex items-center justify-center bg-[#C3E944] hover:bg-[#D4F76F] active:scale-95 text-[#1A1A1A] font-semibold text-[0.875rem] md:text-[1rem] py-3 px-8 rounded-[24px] transition-all duration-200"
            >
